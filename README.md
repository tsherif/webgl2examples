...
- [Order-independent Transparency](https://tsherif.github.io/webgl2examples/oit.html) (vertex arrays, uniform buffers, depth textures, texelFetch, hardware instancing)
